...
CREATE TABLE IF NOT EXISTS `Pinatas_Fantasy`.`Piñata` (
  ...
  INDEX `fk_Piñata_Piñatas_detalles1_idx` (`Piñatas_detalles_idPiñatas_detalles` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Piñata_Festividades1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Piñata_Piñatas_detalles1`
...
-- -----------------------------------------------------
-- Table `Pinatas_Fantasy`.`Direccion_recoger`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Pinatas_Fantasy`.`Direccion_recoger` (
  `idDireccion_recoger` INT NOT NULL,
  `Direccion` VARCHAR(45) NULL,
  PRIMARY KEY (`idDireccion_recoger`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Pinatas_Fantasy`.`pedido` (
  ...
  `usuario_cliente_idusuarios` INT NOT NULL,
  `Direccion_recoger_idDireccion_recoger` INT NOT NULL,
  PRIMARY KEY (`idpedido`, `Piñata_idPiñatas`, `usuario_cliente_idusuarios`, `Direccion_recoger_idDireccion_recoger`),
  ...
  INDEX `fk_pedido_Direccion_recoger1_idx` (`Direccion_recoger_idDireccion_recoger` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_pedido_usuario_cliente1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pedido_Direccion_recoger1`
    FOREIGN KEY (`Direccion_recoger_idDireccion_recoger`)
    REFERENCES `Pinatas_Fantasy`.`Direccion_recoger` (`idDireccion_recoger`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
